...
# DCF-NumPy simulation tx time: transmission_time() * slot_time as
# transmission_time() returns number of slots
dcf_numpy_time = transmission_time(
    backoff_slots=0,
    data_rate=data_rate,
    control_rate=control_rate,
    mac_payload=mac_payload,
    collision=False) * slot_time
